  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute top-40 right-20 w-3 h-3 bg-light-purple rounded-full animate-float"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute bottom-40 left-20 w-2 h-2 bg-deep-purple rounded-full animate-float"
          style={{ animationDelay: "4s" }}
        ></div>
        <div
          className="absolute bottom-20 right-10 w-3 h-3 bg-thistle rounded-full animate-float"
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="animate-slide-up">
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold mb-6">
            Hi, I'm{" "}
            <span className="bg-clip-text bg-gradient-to-r text-thistle">
              Anastansia Chepkosgei{" "}
            </span>
            {/* <span className="text-transparent bg-clip-text bg-gradient-to-r from-thistle to-light-purple">
              Anastansia Chepkosgei{" "}
            </span> */}
          </h1>
          <p
            className="text-xl sm:text-2xl text-slate-300 mb-8 animate-fade-in"
            style={{ animationDelay: "0.3s" }}
          >
            <span className="text-thistle">Software Engineer</span> crafting
            digital experiences with Python & React
          </p>
          <p
